...
namespace BiometricFaceApi.Repositories.Interfaces
{
    public interface ILogMonitorEsdRepository
    {
        ...
        Task<List<LogMonitorEsdModel>> GetLogIncreasingAsync(string serialNumber, int limit);
        Task<List<LogMonitorEsdModel>> GetLogDecreasing(string serialNumber, int limit);
