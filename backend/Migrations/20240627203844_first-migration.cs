        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    Sn = table.Column<string>(type: "varchar(255)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_braceletsAtrribute", x => x.AttributeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonitorEsdEventId = table.Column<int>(type: "int", nullable: true),
                    DatatimeMonitorEsdEvent = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_produceActivity_monitorEsd_MonitorEsdEventId",
                        column: x => x.MonitorEsdEventId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_produceActivity_MonitorEsdEventId",
                table: "produceActivity",
                column: "MonitorEsdEventId");
