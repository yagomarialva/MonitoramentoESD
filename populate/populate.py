...
sql_produce = "INSERT INTO produceactivity (Id, UserId, StationId, MonitorEsdId, IsLocked, Description, DataTimeMonitorEsdEvent) VALUES (%s, %s, %s, %s, %s, %s, %s )"
...
val_produce = []
for i in range(1, 300):
    val_produce.append((i, i, i, i, 1, f'Station for New JIGs {i}', date.today()))
